...
class BaseDatos
{
	...
	AVL<ListaDoble<string>>* arbolEdades;
	int nCol;
...
public:
	...
	BaseDatos() {
		...
		arbolEdades = new AVL<ListaDoble<string>>();
	}

	void lectura(string nombre, int numFilas) {
	...
	void Filtrar() {
		AVL<ListaDoble<string>>* arbolFiltro1;
		arbolFiltro1 = new AVL<ListaDoble<string>>();
		ListaDoble<string> aux;
		int num = 0;
		int opc = 0;
		string cadena = " ";
	...
	void Ordenar() {
		AVL<ListaDoble<string>>* arbolColumna;
		arbolColumna = new AVL<ListaDoble<string>>();
